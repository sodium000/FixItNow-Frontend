...
function getNativeButtonValue(child: React.ReactNode): boolean | undefined {
  ...
  if (componentName === "Button") return true
  if (componentName === "Link") return false
...
function SheetTrigger({ asChild, children, nativeButton, ...props }: SheetPrimitive.Trigger.Props & { asChild?: boolean; nativeButton?: boolean; children?: React.ReactNode }) {
  if (asChild && React.isValidElement(children)) {
    return (
      <SheetPrimitive.Trigger
        data-slot="sheet-trigger"
        nativeButton={nativeButton ?? getNativeButtonValue(children)}
        render={children}
        {...props}
      />
    )
...
function SheetClose({ asChild, children, nativeButton, ...props }: SheetPrimitive.Close.Props & { asChild?: boolean; nativeButton?: boolean; children?: React.ReactNode }) {
  if (asChild && React.isValidElement(children)) {
    return (
